...
export default function Seein(){
    const classes = UseStyle();
    return <div className={classes.root}>
    <Headeri />
        <div className={classes.container}>
            <h1 className={classes.head}>Load data from IPFS </h1>
            <h3 className={classes.label}>Please Enter the Hash :</h3>
            <input className={classes.inputA} id='hash' name='document' type='text'   />
            <h3 className={classes.label}>Enter File Password :</h3>
            <input className={classes.inputA} id='password' name='password' type='password'  />
           <div className={classes.Bcontainer}> <Button className={classes.ButtonS} variant="contained" color="primary" >Download</Button></div>
        </div>
        <Footer />  
    </div>
}